...
const SERVICE_SECTIONS = [
  {
    ...
    title: 'Skin',
    titleAccent: 'Booster',
    desc: 'Give your skin the deep hydration and nourishment it deserves. Skin Booster delivers microdroplets of hyaluronic acid into the top layers of the skin, replenishing moisture, improving texture, and creating a naturally refreshed appearance.',
    bullets: ['Deep Hydration - plumper, more radiant skin', 'Improved Elasticity - firmer, less sagging', 'Smoother Texture - fewer fine lines', 'Natural Glow - boosted luminosity', 'Collagen Stimulation - long-term rejuvenation'],
    imgLeft: true,
    stone: false,
  },
  {
    ...
    title: 'Lip',
    titleAccent: 'Filler',
    desc: 'A premium, non-surgical treatment designed to enhance lip volume, symmetry, and hydration. Whether you prefer a subtle enhancement or a more dramatic appearance, our practitioners customize every treatment to your aesthetic goals.',
  ...
  },
  {
    ...
    desc: 'Refresh your appearance with our Upper Face Neurotoxin Treatment. Using Botulinum Toxin Type A to temporarily relax targeted facial muscles, it produces a smoother, more youthful look while helping prevent deeper wrinkles over time.',
...
const INCLUDED_ITEMS = [
  { title: 'Unlimited Sessions',    desc: 'Access your treatments every month with no expiry and no wasted sessions.',                         icon: <svg width={22} height={22} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.6} strokeLinecap="round" strokeLinejoin="round"><path d="M20 12v6a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h6"/><path d="M15 3h6v6"/><path d="m10 14 11-11"/></svg> },
      ...
      <section className="services-hero">
        ...
        <div className="services-hero__inner">
          ...
          <p data-reveal data-delay="120" className="services-hero__desc">
            Every Al Nojoom membership includes monthly access to our signature aesthetic services, delivered by board-certified specialists.
          </p>
      ...
      <section className="services-cta">
        <div data-reveal className="services-cta__inner">
          ...
          <p className="services-cta__desc">
            All four services - Skin Booster, Lip Filler, Neurotoxin & Beard Trim - available each month, for members only.
          </p>
